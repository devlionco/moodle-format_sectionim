...
$string['displayattendanceinfo'] = 'הצגת פרטי נוכחות';
$string['displayattendanceinfodesc'] = 'הצג או הסתר את הבלוק';
$string['displayattendanceinfodesc_help'] = 'הצג או הסתר את הבלוק';
...
$string['showcoursefullname'] = 'הצג שם מלא של הקורס';
